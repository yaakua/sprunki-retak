...
image: ''
createdAt: '2024-11-06 08:00:00'
---
# Privacy Policy

Sprunki Retake values the privacy of our users. Therefore, this privacy policy explains in detail how we
use and protect the information we collect when you visit our [https://sprunkiretake.fun](https://sprunkiretake.fun), as well as our
...
interaction with Sprunki Retake.

## Information Collected by Sprunki Retake
...
2. Server data related to the IP address you used to visit our [https://sprunkiretake.fun](https://sprunkiretake.fun), which includes
...
Our [https://sprunkiretake.fun](https://sprunkiretake.fun) uses information collected to:
